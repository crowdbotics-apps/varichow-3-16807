"""varichow_3_16807 URL Configuration
...
admin.site.site_header = "Varichow 3"
admin.site.site_title = "Varichow 3 Admin Portal"
admin.site.index_title = "Varichow 3 Admin"

# swagger
schema_view = get_schema_view(
    openapi.Info(
        title="Varichow 3 API",
        default_version="v1",
        description="API documentation for Varichow 3 App",
    ),
    public=True,
